Public Class frmClicker
    ...
    Private Sub btnRandom_Click(sender As Object, e As EventArgs) Handles btnRandom.Click
        If Label1.Text >= 1000 + (modifier) Then
            ...
            ElseIf randomnumber = 3 Then
                If webDecor3.Visible = False Then
                    webDecor3.Visible = True
                    Label2.Visible = True
                    lnkDecor3.Visible = True
                    lblDecor.Visible = True
                    lblDecor.Text = "You got a... GOOGLE PAGE??? :O"
                Else
                    lblDecor.Text = "Aw, it was a duplicate :("
                End If
    ...
    Private Sub Label2_Click(sender As Object, e As EventArgs) Handles Label2.Click
        If webDecor3.Dock = DockStyle.Fill Then
            webDecor3.Dock = DockStyle.None
        Else
            webDecor3.Dock = DockStyle.Fill
        End If

    End Sub

    Private Sub rbtDecor4_CheckedChanged(sender As Object, e As EventArgs) Handles rbtDecor4.CheckedChanged
        If rbtDecor4.Checked = False Then
            frmClicker.DefaultBackColor = 
        End If
    End Sub
End Class
